...
require_once dirname(__DIR__) . '/dysms/api_sdk/vendor/autoload.php';
...
class Sms
{
     ...
     * @return stdClass
     */
    public function sendSms($mobile, $sms_template_code, $param_str, $sign_name) {
        ...
        $request->setTemplateParam($param_str);
